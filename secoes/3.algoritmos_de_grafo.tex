...
\input{secoes/3.1.1.dfs}
\newpage
\input{secoes/3.1.2.bfs}

\subsection{Algoritmos de Caminho Mínimo de Fonte Única}
\input{secoes/3.2.1.dijsktra}
\input{secoes/3.2.2.bellman_ford}
\input{secoes/3.2.3.floyd_warshall}
...
a seguir os dois algoritmos clássicos para resolvê-la. \input{secoes/3.3.1.DSU}
\input{secoes/3.3.2.kruskal} \input{secoes/3.3.3.prim}
...
partir do outro. \input{secoes/3.4.1.kosaraju} \input{secoes/3.4.2.tarjan}
...
fonte ($S$) até um sumidouro ($T$). \input{secoes/3.5.1.dinic}
\input{secoes/3.5.2.kuhn}

\subsection{Algoritmos mais Complexos}
\input{secoes/3.6.1.lca}
\input{secoes/3.6.2.segtree}
\input{secoes/3.6.3.hld}
\input{secoes/3.6.4.centroid_decomposition}